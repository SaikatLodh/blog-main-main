...
function BlogPostCard() {
  ...
  return (
    <div>
      <section className="text-gray-600 body-font post-card-margin">
        <div className=" px-5 py-10 mx-auto max-w-7xl ">
          ...
          <div className="flex flex-wrap justify-center -m-4 mb-5">
            ...
            {getAllBlog.map((item,index)=>{
              ...
              return(
                <div className=" p-4 md:w-1/3 width" >
                <div
                  style={{
                ...
                >
                  {/* Blog Thumbnail  */}
                  <img className=" w-full blog-post-image-height" src={thumbnail} alt="blog" />
