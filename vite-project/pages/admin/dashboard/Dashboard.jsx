...
function Dashboard() {
    ...
    return (
        <Layout>
            <div className="py-10">
                <div
                    className="flex flex-wrap justify-center items-center lg:justify-center gap-2 lg:gap-10 px-4 lg:px-0 dashbord-margin">
                    <div className="left">
                        <img
                ...
                <div className="blog-height">
                    <div className=' mx-auto px-4 max-w-7xl my-5' >
                            ...
                            <table className="w-full border-2 border-white shadow-md text-sm text-left text-gray-500 dark:text-gray-400" >
                                ...
                                <tbody>
                                    ...
                                    {getAllBlog.map((item, index)=>{
                                        ...
                                        return(
                                            <tr className=" border-b-2 dash-blog" style={{ background: mode === 'dark' ? 'rgb(30, 41, 59)' : 'white' }}>
                                            {/* S.No   */}
                                            ...
                                            <th style={{ color: mode === 'dark' ? 'white' : 'black' }} scope="row" className="px-6 py-4 font-medium ">
                                                {/* thumbnail  */}
                                                <img className='blog-image object-cover rounded-lg' src={thumbnail} alt="thumbnail" />
                                            </th>
